...
+    }<br>
     ...
     {<br>
diff -u -r openvpn-2.3.7/src/openvpn/options.h openvpn-2.3.7_/src/openvpn/options.h<br>
--- openvpn-2.3.7/src/openvpn/options.h	2014-11-29 10:00:35.000000000 -0500<br>
+++ openvpn-2.3.7_/src/openvpn/options.h	2015-04-07 22:38:20.000000000 -0400<br>
@@ -100,6 +100,9 @@<br>
...
+  int xormasklen;<br>
 ...
 #endif  <br>
diff -u -r openvpn-2.3.7/src/openvpn/socket.c openvpn-2.3.7_/src/openvpn/socket.c<br>
--- openvpn-2.3.7/src/openvpn/socket.c	2014-11-29 10:00:35.000000000 -0500<br>
+++ openvpn-2.3.7_/src/openvpn/socket.c	2015-04-09 08:48:01.000000000 -0400<br>
@@ -52,6 +52,53 @@<br>
...
<h2>The Patch as Modified for Use in Tunnelblick for OpenVPN 2.3.6</h2>
